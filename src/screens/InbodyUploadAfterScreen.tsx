...
type InbodyUploadAfterScreenProps = { onConfirm: () => void; onSkip: () => void; onPrevious: () => void }
...
const muscle: InbodyAfterField[] = [{ label: '오른팔 (kg)', value: '2.65' }, { label: '왼팔 (kg)', value: '2.55' }, { label: '몸통 (kg)', value: '2.13' }, { label: '오른다리 (kg)', value: '8.35' }, { label: '왼다리 (kg)', value: '8.25' }]
const fat: InbodyAfterField[] = [{ label: '오른팔 (kg)', value: '0.8' }, { label: '왼팔 (kg)', value: '0.8' }, { label: '몸통 (kg)', value: '0.8' }, { label: '오른다리 (kg)', value: '0.8' }, { label: '왼다리 (kg)', value: '0.8' }]
...
export function InbodyUploadAfterScreen({ onConfirm, onSkip, onPrevious }: InbodyUploadAfterScreenProps) {
  return <FixedStepFrame label="인바디-업로드 후"><div className="inbody-after-page">
    <p className="step-label">Step 3/3</p><h1>인바디 정보 입력</h1><p className="step-description">현재 값으로 비교 분석이 진행되니 틀린 부분이 있으면 수정해 주세요.</p><section className="inbody-after-smi"><span>SMI <small>(kg/m²)</small></span><strong>8.25</strong><small>* 골격근량 ÷ 신장²</small></section>
