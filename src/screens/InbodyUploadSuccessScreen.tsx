...
type InbodyUploadSuccessScreenProps = { onChangePhoto: () => void; onStart: () => Promise<void>; onSkip: () => void }
...
export function InbodyUploadSuccessScreen({ onChangePhoto, onStart, onSkip }: InbodyUploadSuccessScreenProps) {
  ...
  return <FixedStepFrame label="인바디 업로드 성공"><div className="inbody-upload-success-page">
    <p className="step-label">Step 3/3</p><h1>인바디 정보 입력</h1><p className="step-description">정확한 분석을 위해 최근 인바디 측정 결과를 입력해 주세요.</p>
